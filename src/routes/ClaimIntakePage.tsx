...
import { Suspense, lazy, useRef, useState, type ReactElement } from 'react';
...
import type { ClaimIntakeDraft } from './claimIntake/ClaimIntakeWizard';
 ...
 */
const ClaimIntakeWizard = lazy(() => {
  console.log('[chunk] ↓ ClaimIntakeWizard (modal open)');
  return import('./claimIntake/ClaimIntakeWizard');
});
  ...
  return (
    <div>
      ...
      <Modal ref={modalRef} labelledBy="claim-intake-title">
        <ErrorBoundary label="Claim intake wizard">
